...
public class Program12 implements Serializable {
    ...
    private static final Logger log = Logger.getLogger(Program12.class);
    ...
    public static void main (String[] args) {
        Program12 program = new Program12(args[0], args[1]);
        //program.process();
        //program.process2();
        program.process3();
    }

    public Program12(String inputURI, String outputURI) {
