...
/**
 * this has some weird behavior once loaded.
 */
public class S3NativeAccessor {

//    private NativeS3FileSystem _s3FileSystem;
//    private JavaSparkContext _sc;
//
//    public S3NativeAccessor(JavaSparkContext sc, String baseURI) throws IOException {
//
//        _sc = sc;
//        _s3FileSystem = new NativeS3FileSystem();
...
//
//        _sc.getConf().log().info("working directory: {}", getWorkingDirectory());
